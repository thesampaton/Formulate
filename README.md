...
Formulate is a proposed React and TypeScript library for composing fields, layouts, sections, and steps into complete form experiences. Validation, conditional behaviour, navigation, and submission work together, while developers own the UI code. React Hook Form and Zod are the default engines.

The project is currently in product and architecture discovery. There is no implementation or published API yet.

- [Part 1 — Product Vision](docs/01-product-vision.md): the product direction and principles.
