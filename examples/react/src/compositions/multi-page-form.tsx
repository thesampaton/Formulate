...
import { FormPendingFields } from "@/components/formulate/form-pending-fields";
...
export function MultiPageForm(props: ProfileFormProps) {
  const { form, navigation, navigateToPage, step, correct, submit, tabs, completeCount, reviewHeading, saved, savedCurrent } = useProfilePages(props);
  return <MultiPageProfile.Form form={form} navigation={step} onInvalid={correct} onSubmit={submit}>
    <header>
    ...
    <FormPendingFields>
      <FormTabs pages={tabs} value={navigation.page} onValueChange={navigation.goTo} onNavigate={navigateToPage}
        ...
        <FormTabPage value="review" title="Review your profile"
          ...
          <div ref={reviewHeading} tabIndex={-1} role="group" aria-label="Profile summary" className="review-summary">
